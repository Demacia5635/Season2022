...
public final class LedHandler {
    ...
    private static final AddressableLEDBuffer buffer = new AddressableLEDBuffer(Constants.LED1_COUNT);
    private static Thread thread = new Thread();

    public static void init() {
        led.setLength(Constants.LED1_COUNT);
        setColor(255, 0, 255);
        led.start();
    }
    ...
    public static void setColor(int red, int green, int blue) {
        stopCurrentTransition();
        for (int i = 0; i < Constants.LED1_COUNT; i++) {
